    ...
    const model: AppMenuItem[] = [
        {
            label: 'Application',
            items: [
                { label: 'Poc', icon: 'pi pi-fw pi-pencil', to: '/poc/' },
                { label: 'Register', icon: 'pi pi-fw pi-pencil', to: '/register/' },
                { label: 'Login', icon: 'pi pi-fw pi-pencil', to: '/login/' },
                { label: 'Sales', icon: 'pi pi-fw pi-pencil', to: '/sales/' },
            ]
